...
describe("Cadastramento de pets", () => {
    ...
    it("Cadastrar - Campo 'nome' é obrigatório", () => {
        const resultado = pets.cadastrar({ nome: "chiquinho",idade: 10, sexo: "M", especie: "Gato" });
    ...
    it("Cadastrar - Campo 'idade' é obrigatório", () => {
        const resultado = pets.cadastrar({ nome: "Catz", idade:2, sexo: "M", especie: "Gato" });
        expect(resultado).toEqual(expect.objectContaining({
            id: expect.any(Number),
            nome: expect.any(String),
            idade: expect.any(Number),
    ...
    it("Cadastrar - Campo 'sexo' é obrigatório", () => {
        const resultado = pets.cadastrar({ nome: "Catz", idade: 10, especie: "Gato",sexo : 'M' });
        expect(resultado).toEqual(expect.objectContaining({
            id: expect.any(Number),
            nome: expect.any(String),
            idade: expect.any(Number),
    ...
    it("Cadastrar - Campo 'espécie' é obrigatório", () => {
        const resultado = pets.cadastrar({ nome: "Catz", idade: 10, sexo: "M", especie: "gato" });
        expect(resultado).toEqual(expect.objectContaining({
            id: expect.any(Number),
            nome: expect.any(String),
            idade: expect.any(Number),
    ...
    it("Cadastrar - campo 'idade' deve ser maior ou igual a 0", () => {
        pet = { nome: "Zeus", idade: 2, sexo: 'M', especie: 'cachorro'};
    ...
    it("Cadastrar - campo 'sexo' deve ser 'M' ou 'F'", () => {
        pet = { nome: "Zeus", idade: 5, sexo: 'M', especie: 'cachorro'};
        expect(pets.cadastrar(pet)).toEqual(
            expect.objectContaining({
                id: expect.any(Number),
                nome: expect.any(String),
